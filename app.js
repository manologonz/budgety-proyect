...
const budgetController = (function () {
    ...
    return {
        ...
        deleteItem: function (type, id) {
            ...
            // obtaining the index of the id to be deleted.
    ...
    return {
        ...
        addListItem: function (obj, type) {
            ...
            if (type === "inc") {
                ...
                var html = `<div class="item clearfix" id="inc-%id%">
                    <div class="item__description">%description%</div>
                    <div class="right clearfix">
                        <div class="itsem__value">%value%</div>
        ...
        clearFields: function () {
            ...
            // access to the current value, the index number, the array.
